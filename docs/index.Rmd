...
These results could support the hypothesis that *Ramicrusta* has the ability to remineralize coral nutrients as it colonizes coral colonies. Because of isotopic fractionation during metabolic events in heterotrophic consumers, the significantly higher N signatures found in the alga overgrowing *O. annularis*  may have been a result of coral-derived nutrients. However, it was anticipated that the highest N signatures would occur when the alga was directly interacting with live coral tissue. Additionally, the apical regions of macroalgae thallus  generally exhibit enriched d15N values because the high N demand associated with new growth reduces N species selection, while the N supply available for the older portions of the thallus increases relative to it's demand (Umezawa et al., 2007). As this is the first isotopic study conducted on the genus *Ramicrusta*, it's difficult to interpret these nutrient snapshots when information on it's nutrient history is lacking. 

Umezawa et al. (2007) found similar results in *Padina australis*. 

- First, Tyler et al. (2001) demonstrated that the red alga *Gracilaria vermiculophylla* releases surplus DON when undergoing periods of senescence. Although the processes as to if 15N depleted is excreted are less understood in macroalgae, Waser et al. (1998) found that the diatom *Thalassiosia psudonana* released 14N during incubation. 

- Second, physiological stress disrupts the coral-symbiont relationship, as seen in bleaching events where corals expel symbionts under heat stress. Competition can also trigger the release of symbionts, disruption N recycling within the holobiont. Typically, corals corals exhibit low d15N values because symbionts retain 14N. However, this expulsion releases the isotopically light N as ammonium into the water column. This ammonium leakage may explain the low d15N values observed in *Ramicrusta* at the active site of coral overgrowth. 

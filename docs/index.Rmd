...
These results may support the hypothesis that *Ramicrusta* has the ability to remineralize coral nutrients as it colonizes coral colonies. Because of isotopic fractionation during metabolic events, the significantly higher N signatures found in the alga overgrowing *O. annularis* colonies may have been a result of coral-derived nutrients. However, it was anticipated that the highest N signatures would occur when the alga was directly interacting with live coral tissue. Even though the N signatures were enriched in *R. textilis* tissues extracted from coral colonies, the consistently lower N signatures observed in the alga's apical regions across both substrates may have resulted from a reduced selection for nitrogen species, driven by the high nitrogen demand associated with new growth (Umezawa et al., 2007). 
- healthy macroalgae can release isotopically light N compounds when N-saturated; however, high irradiance can initiate the leaking of N from lysis via photodamage

...
A two-factor ANOVA with a log transformation revealed significant differences in *Ramicrusta's* $\delta^{15}$N for substrate type (p-value = 0.04978) and growth region (p = 0.01112), but no difference was observed in the interaction effect of the two factors. Both the marginal ($\delta^{15}$N = 1.66 ± 0.10) and non-marginal ($\delta^{15}$N = 1.81 ± 0.06) *R. textilis* samples growing on *O. annularis* had higher N signatures than the corresponding control samples ($\delta^{15}$N = 1.36 ± 0.13 and 1.78 ± 0.13, respectively). However, the marginal alga samples for each substrate had consistently lower N signatures than the non-marginal replicates. 
...
<p align="center">
<figcaption><small>Fig. 4: .</small></figure>

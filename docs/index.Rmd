...
Based on predictable isotope fractionation patterns (Fry, 1988), the ability of the alga to remineralize coral nutrients can be evaluated by comparing the nutrient levels in both the alga and coral tissues through bulk stable isotope analyses. Fractionation refers to the preferential use of the lighter isotope (12C, 14N) during metabolic processes, concentrating the heavier form in the organism’s tissues (13C, 15N) (Rounick & Winterbourn, 1986; Fry, 1988; Cohen & Fong, 2004). In heterotrophic consumers, the ratio of heavy to light isotopes for carbon (C) and nitrogen (N) generally enrich by 1‰ and 3‰  per trophic level, respectively (Fry, 1988). These ratios, or isotope signatures, are represented by the delta notation in parts per thousand (δ13C, δ15N). This unique aspect of isotope fractionation provides insight into a consumer's food source (δ13C)  and trophic position (δ15N) (Rounick & Winterbourn, 1986; Post et al., 2002).  However, primary producers typically exhibit a lack of fractionation (Gartner et al., 2002; Cohen & Fong, 2004; Strait et al., 2021). Thus, both the C and N signatures generally reflect their source. As a result, macroalgal bioassays serve as powerful proxies for nutrient studies in oligotrophic environments because tissue analyses can trace nutrient sourcing (δ13C, δ15N), availability (C%, N%), and limitations (C:N) in the surrounding water (Amato et al., 2016; Amato et al., 2018; Strait et al., 2021). 
...
The following are the preliminary methods, results, and conclusions from a pilot study conducted on September 2, 2024. hh
...
<figure style="text-align:center;">
  ...
  <p align="center">
  <figcaption>Fig. 2: Site</figcaption>
</figure>
